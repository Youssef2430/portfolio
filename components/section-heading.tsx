    ...
    <div ref={ref} id={id} className="mb-12">
      ...
      >
        ...
        <AnimatePresence>
          {isHovering && (
            <motion.div
              className="absolute left-1/2 transform -translate-x-1/2 -bottom-8 bg-white dark:bg-black border border-black dark:border-white rounded-sm px-3 py-1 shadow-sm"
