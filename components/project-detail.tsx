...
// `icon` is a ReactNode and can't cross the server->client boundary
export type SerializableProject = Omit<ProjectDetail, "icon">;

export function ProjectDetailView({ project }: { project: SerializableProject }) {
